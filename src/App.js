...
const Characters = lazy(() =>
  import("./components/resource/characters.component")
);
...
const Favorites = lazy(() =>
  import("./components/resource/favorites/favorites.component")
);
const ListElementDetails = lazy(() =>
  import("./components/resource/listElementDetails.component")
);
        ...
        <Suspense fallback={<LoadingScreen />}>
          <Switch>
            ...
            <Route
              path="/characters/:id"
              render={(props) => (
                <ListElementDetails {...props} resource="characters" />
              )}
            ></Route>
            ...
            <Route
              path="/comics/:id"
              render={(props) => (
                <ListElementDetails {...props} resource="comics" />
              )}
            ></Route>
            ...
            <Route
              path="/stories/:id"
              render={(props) => (
                <ListElementDetails {...props} resource="stories" />
              )}
            ></Route>
